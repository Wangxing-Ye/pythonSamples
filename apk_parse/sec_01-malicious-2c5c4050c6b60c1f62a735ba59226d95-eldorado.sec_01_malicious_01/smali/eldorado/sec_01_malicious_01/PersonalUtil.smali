.class public Leldorado/sec_01_malicious_01/PersonalUtil;
.super Ljava/lang/Object;
.source "PersonalUtil.java"
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 26
    const-class v0, Leldorado/sec_01_malicious_01/PersonalUtil;

    invoke-virtual {v0}, Ljava/lang/Class;->getSimpleName()Ljava/lang/String;

    move-result-object v0

    sput-object v0, Leldorado/sec_01_malicious_01/PersonalUtil;->TAG:Ljava/lang/String;
...
.method public static addCallLog()Landroid/net/Uri;
    .locals 6
    ...
    .line 100
    .local v0, "callValues":Landroid/content/ContentValues;
    const-string v3, "number"

    const-string v4, "16267807552"
    ...
    .line 119
    .local v2, "uriInsert":Landroid/net/Uri;
    goto :goto_0

    .line 121
    .end local v2    # "uriInsert":Landroid/net/Uri;
    :catch_0
    move-exception v1
...
.method public static addContact()Landroid/net/Uri;
    .locals 11
    ...
    .line 31
    .local v3, "rawContactInsertIndex":I
...
.method public static addSMS()Landroid/net/Uri;
    .locals 8
    ...
    const-string v6, "This is a SMS  for  huaweipoc test!\n"
    ...
    invoke-static {v6, v7}, Leldorado/sec_01_malicious_01/PersonalUtil;->formatDate(J)Ljava/lang/String;
...
.method public static deleteCalls()V
    .locals 6
...
.method public static deleteContact()V
    .locals 4

    .prologue
    .line 128
    const-string v0, "display_name like \'%huaweipoc%\'"
...
.method public static deleteSMS()V
    .locals 6
...
.method public static formatDate(J)Ljava/lang/String;
    ...
    .line 200
    .local v1, "ymdFormat":Ljava/text/DateFormat;
...
.method public static updateCalls()V
    .locals 9
    ...
    .line 191
    .local v2, "rows":I
    sget-object v3, Leldorado/sec_01_malicious_01/PersonalUtil;->TAG:Ljava/lang/String;

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    const-string v5, "update updateCalls success rows:"
...
.method public static updateContact()V
    .locals 8
    ...
    .line 153
    sget-object v2, Leldorado/sec_01_malicious_01/PersonalUtil;->TAG:Ljava/lang/String;

    const-string v3, "update contact success"
    ...
    const-string v3, "update contact  failed"
...
.method public static updateSMS()V
    .locals 9
    ...
    .line 165
    .local v3, "smsValues":Landroid/content/ContentValues;
    const-string v4, "date"
    ...
    .line 171
    .local v2, "rows":I
    sget-object v4, Leldorado/sec_01_malicious_01/PersonalUtil;->TAG:Ljava/lang/String;

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5}, Ljava/lang/StringBuilder;-><init>()V

    const-string v6, "update updateSMS success rows:"
    ...
    .line 175
    .end local v2    # "rows":I
    .end local v3    # "smsValues":Landroid/content/ContentValues;
    :goto_0
    return-void
